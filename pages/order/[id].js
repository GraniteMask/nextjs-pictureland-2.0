...
function reducer(state, action){
    switch(action.type){
        ...
        case 'DELIVER_RESET':
            return {...state, loadingDeliver: false, errorDeliver: '', successDeliver: false}
        default:
            state
    }
}
...
function Order({params}) {
    ...
    function createOrder(data,actions){
        return actions.order.create({
            ...
            return orderID //this order id is created is created by paypal
        })
    } 
...

                            {
                                userInfo.isAdmin && order.isPaid && !order.isDelivered && (
                                    <ListItem>
                                        ...
                                        <Button fullWidth variant="contained" color="primary" onClick={deliverOrderHandler}>Deliver the order</Button>
                                    </ListItem>
                                )
                            }
                        </List>
